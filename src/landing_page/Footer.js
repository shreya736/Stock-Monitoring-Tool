    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <br></br>
          <a href="" style={{textDecoration:"none"}}>List of changes</a>
          <br></br>
          <a href="" style={{textDecoration:"none"}}>Downloads & resourse</a>
          <br></br>
        </div>
        <div className="col">
          <p>Account</p>
      ...
      <p>
        ...
        the day. Issued in yhe investors. KYC is one time exercise while dealing
