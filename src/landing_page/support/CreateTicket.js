  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="">To create a ticket, select a relevent topic</h1>
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Changes at Zerodha</a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
            <i class="fa-light fa-circle"></i>Coin
          </h4>
          <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Understanding Mutual</a><br/>
